...
import paymentintegrations.ResponseListener;
import paymentintegrations.view.LauchSignalR;
...
public class MainActivity extends AppCompatActivity implements ResponseListener {
    ...
    public ActivityComponent getActivityComponent() {
        if (activityComponent == null) {
            activityComponent = DaggerActivityComponent.builder()
                    ...
                    .applicationComponent(com.mindorks.example.android_dagger2_example.DemoApplication.get(this).getComponent())
                    .build();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //new LauchSignalR().launch(MainActivity.this,this);
...
//        mDataManager.saveAccessToken("ASDR12443JFDJF43543J543H3K543");
    ...
    @Override
    public void onResponseSuccess(String response, int screenId) {
        Log.d("TAG",""+response+screenId);
    }
}
